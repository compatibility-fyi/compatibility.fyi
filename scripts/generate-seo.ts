...
async function writeLlms() {
  ...
  await writeFile(
    ...
    [
      ...
      '- [Compatibility Gate for GitHub Actions](https://github.com/compatibility-fyi/compatibility-gate#github-quickstart)',
      '- [Compatibility Gate for GitLab CI](https://github.com/compatibility-fyi/compatibility-gate#gitlab-quickstart)',
